...
-p pipeline:    seqlienr pipeline to use. only if -s specified
-d time:        desired duration of job (DD-HH:MM:SS, e.g. 4 hours = 04:00:00)
...
def main():
    ...
    if options.type is not None:
        ...
        try:
            ...
            print("please set correct sbatch type: generic, variant, chip or alignment. Defaulting to generic")
            filetype = "generic"
    else:
        filetype = "generic"
